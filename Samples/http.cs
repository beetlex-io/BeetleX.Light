...
AwaiterNetClient<HttpClientChannel> client = "https://www.baidu.com";
client.SslServiceName = "www.baidu.com";
client.LogLevel = LogLevel.Trace;

client.AddLogOutputHandler<LogOutputToConsole>();
HttpRequest request = new HttpRequest();
request.Url = "/?tn=68018901_16_pg";
var response = await client.Request<HttpResponse>(request);
Console.ReadLine();
